<template>
    <div class="box">
        ...
        <div class="box-item-stats">
            <p class="blue">Przypadki <span>{{ data.cases }}<small v-if="showNews">(+{{ data.new_cases }})</small></span></p>
            <p class="red">Zgony <span>{{ data.deaths }}<small v-if="showNews">(+{{ data.new_deaths }})</small></span></p>
            <p class="green">Ozdrowienia <span>{{ data.recovered }}<small v-if="showNews">(+{{ data.new_recovered }})</small></span></p>
        </div>
    </div>
</template>
